...
:deep(.menu_scrollbar) {
  ...
  .menu_view {
    ...
    .el-menu-item {
      ...
      margin: 0 0 10px;
      color: #fff;
      background: url(http://localhost:8080/corporateCredit/file/788e398402af41feb930956f06d3db32.png)
        repeat-x center bottom / 100% auto;
      border-color: #c61c1430;
    ...
    .el-menu-item:hover {
      ...
      background: linear-gradient(
        ...
        rgba(249, 131, 40, 1) 51%,
        rgba(251, 154, 38, 1) 100%
      );
      border-color: #d9171560;
      border-width: 0 0 0px;
      line-height: 40px;
      border-style: solid;
      height: 40px;
