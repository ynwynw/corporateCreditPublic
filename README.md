...
**博客地址：
[https://blog.csdn.net/2303_76227485/article/details/142639079](https://blog.csdn.net/2303_76227485/article/details/142639079)**
...
## 基于Java+Springboot+vue3的企业信用信息管理系统(源代码+数据库)184

## 一、系统介绍
本项目前后端分离(可以改为ssm版本)，分为用户、管理员两种角色
### 1、用户：
- 注册、登录、新闻资讯、失信信息、企业信息、我的收藏、个人信息、密码修改
### 2、管理员：
- 管理员管理、用户管理、企业信息管理、失信预警管理、失信提交、失信信息管理、新闻资讯管理、轮播图管理
